...
class LSTMOptimizer_Trainer():
    def __init__(self):
        ...
        with self.graph.as_default():
            ...
            self.loss = self.loss / num_samples
    ...
    def train(self):
        ...
        for epoch in range(max_epoch):
            cost, _ = self.sess.run([self.loss, self.train_op]) # 计算loss并更新lstm的参数
